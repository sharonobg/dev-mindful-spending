...
const EditTransactionById = ({ params }: { params: { id: string } }) => {
    ...
    //console.log('setTransactionDetails',transactionDetails)
    // useEffect(() => {
...
const handleSubmit= async (e:React.FormEvent<HTMLFormElement>) => {
    ...
    try{
        ...
        body:JSON.stringify({
            ...
            //categoryTitle,
            acctype:acctype? acctype: transactionDetails?.acctype,
        })
    })
    //console.log('transdatePre',transdatePre)
        ...
        <div className="outerDiv">
           ...
           <pre>Categories:{JSON.stringify(categories, null, 2)}</pre>*/}
            ...
            <label>Category:</label>
             <select id="categoryselect" defaultValue={transactionDetails.categoryId} onChange={
            (e:ChangeEvent<HTMLSelectElement>) => setCategoryId(e.target.value)
            }>
            {categories?.length > -1 ? 
            ...
            <input 
                ...
                value={acctype? acctype :transactionDetails?.acctype as Accounttype}
                >
