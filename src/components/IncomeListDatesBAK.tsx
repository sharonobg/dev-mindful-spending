    ...
    return(
      ...
      <pre>GET income list dates:{JSON.stringify(incomelist, null, 2)}</pre>
       ...
       <div className="font-bold horizGrid grid-cols-6 md:grid-cols-8 w-full align-middle">
            ...
            <div className="col-span-2">Descr<span className="hidden md-flex">iption</span></div>
        ...
        <div key={income.id} className="w-full">
            ...
            (`${props.category}` === 'all-categories' ||  transaction.title == `${props.category}`) &&  */}
                ...
                <div className="col-span-2 p-2">{income._id.month}/{income._id.day}/{income._id.year}</div>
                <div className="col-span-2 p-2 flex-wrap">{income?._id.incomedescr}</div>
                <div className="hidden md:flex md:col-span-2 p-2">{income._id.incometype}</div>
                <div className="col-span-2 py-2">{parseFloat(income._id.incomeamount).toFixed(2)}</div>
