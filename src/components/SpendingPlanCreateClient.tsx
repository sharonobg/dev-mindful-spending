...
export default function CreateSpendingPlan({categories}:{categories:[Category]}) {
...
// }
    return(
     ...
     <div  className="flex flex-row  min-w-fit w-full">
        <div className="flex flex-col border-r-2 border-blue-500 mr-5">
        {categories?.length > -1 ? (categories.slice(1).map((category:any,index:number) =>
